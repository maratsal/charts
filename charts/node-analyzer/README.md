...
| `ssl.ca.cert`                    | SSL CA Bundle/Certificate in x509 PEM format                                                                                                            | ` `                                                         |
| `ssl.ca.fileName`                | SSL CA Bundle/Certificate Filename to use inside the created Secret                                                                                     | ` `                                                         |
| `ssl.ca.existingCaSecret`        | Existing Secret containing the SSL CA Bundle/Certificate                                                                                                | ` `                                                         |
| `ssl.ca.existingCaSecretFileName` | Filename of the existing Secret SSL CA Bundle/Certificate (eg; ca_bundle.crt)                                                                           | ` `                                                         |
| `ssl.ca.existingCaConfigMap`     | Existing ConfigMap containing the SSL CA Bundle/Certificate                                                                                             | ` `                                                         |
| `ssl.ca.existingCaConfigMapFileName` | Filename of the existing ConfigMap SSL CA Bundle/Certificate (eg; ca_bundle.crt)                                                                        | ` `                                                         |
