...
*/}}
{{- define "admissionController.sslCaFileName" -}}
    {{- if include "admissionController.existingCaSecret" ( dict "root" .root "name" .name ) }}
      {{- include "admissionController.existingCaSecretFileName" ( dict "root" .root "name" .name ) -}}
...
*/}}
{{- define "admissionController.existingCaSecretFileName" -}}
    {{/*
...
This is used when we specify the agent ca_certificate as well as the SSL_CERT_FILE environment variable
*/}}
{{- define "admissionController.existingCaConfigMapFileName" -}}
    {{/*
    Note: the last default function call is to avoid some weirdness when either
